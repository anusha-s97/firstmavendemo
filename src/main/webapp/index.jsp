...
<head>
	...
	<link rel="stylesheet" type="text/css" href=https://github.com/anusha-s97/firstmavendemo/blob/master/src/main/webapp/assports.css">
</head>
<body>
	<div id="showcase">
		<header>
	...
	<footer>
		<div class="container">
			<div class="footer-cols">
				...
				<ul>
					...
					<li>
						<a href="#">Outdoor Sports Items</a>
					</li>
				</ul>
				<ul>
					<li>Euducation and Business</li>
					<li>
						<a href="#">AS Sports Education</a>
					</li>
					<li>
		...
		<div class="footer-bottom">
			Copyright &copy; 2022 Great Learning
		</div>
	</footer>
</body>
</html>
